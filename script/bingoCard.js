function BingoCard() {
    ...
    this.matrix = [];
    //Method generate Matrix the will put a values to the matrix. var o [];
    this.generateMatrix = () =>{
        ...
        //Bingo card column B has numbers from 1 to 15, using the formula (maximum - minimum) + 1 we will get the numbers range
        for (var a = 0; a < 5; a++) {
